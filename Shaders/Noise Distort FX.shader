...
Shader "Tsuna/Noise Distort FX"
{
	Properties
	{
		...
		[Toggle(_)][Header(Mask)]_UseDistortMask("Use Distort Mask Texture", Float) = 0
		[SingleLineTexture]_DistortMask("Distort Mask", 2D) = "white" {}
		[Toggle(_)][Header(World Limit)]_UseWorldLimit("Use World Limit", Float) = 0
		_MinRange("Min Range", Range( 0 , 6)) = 6
		_MaxRange("Max Range", Range( 0 , 6)) = 2.537596
		_DissolveDirection("Exclusion Area", Vector) = (0,0,0,0)
		[Toggle(_)][Header(Options)]_UseGlobalPosition("Use Global Position", Float) = 0
	...
	SubShader
	{
		...
		uniform float _UseDistortMask;
		uniform float _UseWorldLimit;
		uniform float _UseGlobalPosition;
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float3 ifLocalVar75 = 0;
			if( _UseGlobalPosition == 1.0 )
				ifLocalVar75 = ase_worldPos;
			else
				ifLocalVar75 = ase_vertex3Pos;
			float3 appendResult1 = (float3(_Time.y , _Time.y , _Time.y));
			float simplePerlin3D31 = snoise( ( ( ifLocalVar75 - appendResult1 ) * _DistortSpeed )*_DistortScale );
			simplePerlin3D31 = simplePerlin3D31*0.5 + 0.5;
			float3 temp_output_3_0 = ( ( simplePerlin3D31 * (-1.0 + (simplePerlin3D31 - 0.0) * (1.0 - -1.0) / (1.0 - 0.0)) * _DistortStrength ) * _DistortDirection );
			float4 PlayerTransform14 = float4( _DissolveDirection , 0.0 );
			float3 VertWorldPos14 = ifLocalVar75;
			...
			float3 ifLocalVar72 = 0;
			if( _UseWorldLimit == 1.0 )
				ifLocalVar72 = ( temp_output_3_0 * localComposeTrackingData14 );
			else
				ifLocalVar72 = temp_output_3_0;
			...
			if( _UseDistortMask == 1.0 )
				ifLocalVar69 = ( float4( ifLocalVar72 , 0.0 ) * tex2Dlod( _DistortMask, float4( uv_TexCoord48, 0, 0.0) ) );
			else
				ifLocalVar69 = float4( ifLocalVar72 , 0.0 );
			v.vertex.xyz += ifLocalVar69.rgb;
		}
...
/*ASEBEGIN
Version=18100
844.8;414.4;1595;1037;2782.028;753.0773;1;True;False
Node;AmplifyShaderEditor.SimpleTimeNode;11;-1369.818,267.1454;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.WorldPosInputsNode;74;-1914.621,11.28979;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;76;-1921.837,-266.6664;Inherit;False;Property;_UseGlobalPosition;Use Global Position;22;0;Create;False;0;0;False;2;Toggle(_);Header(Options);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.PosVertexDataNode;16;-1914.41,-145.4026;Inherit;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ConditionalIfNode;75;-1408.576,-137.8063;Inherit;False;False;5;0;FLOAT;0;False;1;FLOAT;1;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;4;-1109.258,457.0479;Inherit;False;Property;_DistortSpeed;Distort Speed;14;0;Create;False;0;0;False;0;False;1;0.16;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;6;-864.4599,531.2193;Inherit;False;Property;_DistortScale;Distort Scale;13;0;Create;False;0;0;False;0;False;6.411765;2.49;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;8;-506.7703,624.7592;Inherit;False;Property;_DistortStrength;Distort Strength;12;0;Create;False;0;0;False;1;Header(Vertex Distort);False;1;0.38;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;18;-1011.93,9.331598;Inherit;False;Property;_MinRange;Min Range;19;0;Create;True;0;0;False;0;False;6;1.2;0;6;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector4Node;45;-2012.074,672.0022;Inherit;False;Property;_TilingandOffset;Tiling and Offset;11;0;Create;False;0;0;False;0;False;1,1,0,0;1,1,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;19;-1011.93,108.3316;Inherit;False;Property;_MaxRange;Max Range;20;0;Create;True;0;0;False;0;False;2.537596;1.91;0;6;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector3Node;17;-1086.71,-269.3421;Inherit;False;Property;_DissolveDirection;Exclusion Area;21;0;Create;False;0;0;False;0;False;0,0,0;0,1,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.Vector3Node;2;689.2302,367.1418;Inherit;False;Property;_DistortDirection;Distort Direction;15;0;Create;False;0;0;False;0;False;0,0,0;1,0,1;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;41;1107.329,115.4043;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;73;473.5755,115.0581;Inherit;False;Property;_UseWorldLimit;Use World Limit;18;0;Create;False;0;0;False;2;Toggle(_);Header(World Limit);False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ConditionalIfNode;72;1273.035,197.818;Inherit;False;False;5;0;FLOAT;0;False;1;FLOAT;1;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SamplerNode;71;984.4465,-377.3236;Inherit;True;Property;_DistortMask;Distort Mask;17;1;[SingleLineTexture];Create;False;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;54;217.1368,1169.305;Inherit;False;Property;_NormalMapSlider;Normal Map Slider;8;0;Create;False;0;0;False;0;False;1;1;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;50;1131.634,810.5367;Inherit;False;Property;_EmissionColor;Emission Color;10;1;[HDR];Create;False;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;70;1437.462,93.64194;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;68;1024,-32;Inherit;False;Property;_UseDistortMask;Use Distort Mask Texture;16;0;Create;False;0;0;False;2;Toggle(_);Header(Mask);False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;12;1281.561,395.4579;Inherit;False;Property;_CullMode;Cull Mode ( 0 = None, 1 = Front, 2 = Back);24;0;Create;False;0;0;True;1;Header(Culling);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ConditionalIfNode;69;1600,96;Inherit;False;False;5;0;FLOAT;0;False;1;FLOAT;1;False;2;FLOAT3;0,0,0;False;3;COLOR;0,0,0,0;False;4;FLOAT3;0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;13;911.0906,-159.3788;Inherit;False;Property;_Clip;Clip;23;1;[HideInInspector];Create;False;0;0;True;0;False;0.5;0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;1832.223,-75.17404;Float;False;True;-1;2;ASEMaterialInspector;0;0;Standard;Tsuna/Noise Distort FX;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Opaque;0.5;True;True;0;False;Opaque;;Geometry;All;14;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;0;0;False;-1;0;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;False;0;0;True;12;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
WireConnection;75;0;76;0
WireConnection;75;2;16;0
WireConnection;75;3;74;0
WireConnection;75;4;16;0
...
WireConnection;72;2;3;0
WireConnection;72;3;41;0
WireConnection;72;4;3;0
...
ASEEND*/
//CHKSM=95CEB9FDBE9DAACFF16BAD2FCE841EC0AA91CABC