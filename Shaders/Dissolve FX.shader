...
Shader "Tsuna/Dissolve FX"
{
	Properties
	{
		...
		_DissolveClip("Dissolve Clip", Range( 0 , 1)) = 0.5
...
/*ASEBEGIN
Version=18100
-1853;498.2;1788;978;-2352.935;876.4306;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;2;3392.169,-547.3073;Inherit;False;Property;_DissolveClip;Dissolve Clip;14;0;Create;True;0;0;True;0;False;0.5;0.5;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;148;1421.875,-1298.867;Inherit;False;Property;_ThanksforusingmyShader;Thanks for using my Shader!;0;0;Create;True;0;0;True;5;Header(Shader by tsuna vr);Header(Discord bDWEYUw);Header(Visit for commissions and free stuff);Space(25);Toggle(_);False;0;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=9BEA2F9CAFFC6EFBF5003F26A9D03652945DF9B5